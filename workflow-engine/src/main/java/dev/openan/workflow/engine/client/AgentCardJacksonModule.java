          ...
          return switch (entry.getKey()) {
            case "httpAuthSecurityScheme" -> {
              ...
              yield new HTTPAuthSecurityScheme(
                  textOrNull(inner, "bearerFormat"), scheme, textOrNull(inner, "description"));
            }
            ...
            case "oauth2SecurityScheme" ->
                new OAuth2SecurityScheme(
                    null, textOrNull(inner, "description"), textOrNull(inner, "oauth2MetadataUrl"));
            case "openIdConnectSecurityScheme" -> {
              ...
              yield new OpenIdConnectSecurityScheme(url, textOrNull(inner, "description"));
            }
            default -> null;
          };
        }
