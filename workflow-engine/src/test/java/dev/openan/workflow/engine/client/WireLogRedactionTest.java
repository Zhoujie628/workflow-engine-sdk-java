...
class WireLogRedactionTest {
    ...
    @Test void extensionUriKeysCarryingBusinessContentAreNotRedacted() {
        String payload = "{\"artifact\":{\"metadata\":{"
        ...
        assertFalse(WireLog.sensitive("https://projects.tmforum.org/a2aproject/telecommunication/extensions/Authorization-T/v1"));
    }
}
