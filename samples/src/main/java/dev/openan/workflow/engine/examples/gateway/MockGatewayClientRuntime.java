 ...
 * AgentCard routing, streaming selection, timeout conversion, response parsing, terminal detection,
 * logging and session lifecycle all execute through the production adapter.
 */
public final class MockGatewayClientRuntime
  ...
  @Override
  public java.util.concurrent.CompletableFuture<dev.openan.workflow.engine.model.SendMessageResult>
      subscribeToTask(
          AgentCard agentCard,
          String taskId,
          org.a2aproject.sdk.client.transport.spi.interceptors.ClientCallContext callContext,
