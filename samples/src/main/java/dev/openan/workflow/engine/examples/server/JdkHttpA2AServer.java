...
public class JdkHttpA2AServer implements AutoCloseable {
  ...
  public JdkHttpA2AServer(
    ...
    this.server.createContext(
        pathPrefix.isEmpty() ? "/" : pathPrefix, exchange -> handleExchange(exchange, restHandler));
  ...
  private static Map<String, String> queryParams(HttpExchange exchange) {
    ...
    for (String pair : rawQuery.split("&")) {
      ...
      String value = fields.length == 2 ? URLDecoder.decode(fields[1], StandardCharsets.UTF_8) : "";
