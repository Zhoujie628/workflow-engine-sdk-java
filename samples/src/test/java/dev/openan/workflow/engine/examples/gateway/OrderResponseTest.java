...
class OrderResponseTest {
  @Test
  void preservesStatusBodyAndRepeatedHeadersWithoutSharingMutableContainers() {
    ...
    assertThrows(
        UnsupportedOperationException.class, () -> response.headers().put("Other", List.of()));
    assertThrows(
        UnsupportedOperationException.class, () -> response.headers().get("X-Multi").add("three"));
  }
}
