...
class DemoNegotiationSettingsTest {
    ...
    @BeforeEach void isolateSettings() {
    ...
    @Test void localDefaultSelectsOnlyCity1AndDoesNotMutateGlobalSettings() {
    ...
    @Test void explicitDisableKeepsCompleteInputs() {
    ...
    @Test void externalOmcNeverGetsDefaultInjectionAndRejectsExplicitInjection() {
        assertFalse(SpnCasePrompts.demoNegotiationEnabled(false));
        System.setProperty("a2at.samples.negotiation", "true");
        assertThrows(IllegalArgumentException.class, () -> SpnCasePrompts.demoNegotiationEnabled(false));
    }

    @Test void invalidSwitchOrCityFailsBeforeStartingServers() {
